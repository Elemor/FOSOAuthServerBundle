...
class OAuthFactory implements SecurityFactoryInterface, AuthenticatorFactoryInterface
{
    public function createAuthenticator( ContainerBuilder $container, string $firewallName, array $config, string $userProviderId )
    {
        ...
        $container
            ->setDefinition($managerId = 'security.authenticator.oauth2.'.$firewallName, new ChildDefinition('security.authenticator.manager'))
        ...
        $listeners[] = new Reference('security.firewall.authenticator.'.$firewallName);
